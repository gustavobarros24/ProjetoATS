...
public class UtilizadorTest {
    ...
    public void testAddFaturaAndPeriodoCalculations() {
        ...
        Fatura f1 = new Fatura(100f, Fatura.Tipo.VENDA, e, now.minusDays(1), Arrays.asList(1));
        Fatura f2 = new Fatura(200f, Fatura.Tipo.COMPRA, e, now.minusDays(3), Arrays.asList(2));
        Fatura f3 = new Fatura(150f, Fatura.Tipo.VENDA, e, now.minusDays(2), Arrays.asList(3));
