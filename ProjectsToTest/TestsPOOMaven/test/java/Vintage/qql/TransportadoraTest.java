...
public class TransportadoraTest {
    ...
    void testCalculaPrecoExpedicaoPequeno() {
        ...
        assertEquals(expected, t.calculaPrecoExpedicao(Encomenda.TamanhoEmbalagem.PEQUENO), 0.001f);
    }

    @Test
    void testCalculaPrecoExpedicaoMedio() {
        float expected = (20.0f * 1.6f * (1 + 0.2f)) * 0.9f;
        assertEquals(expected, t.calculaPrecoExpedicao(Encomenda.TamanhoEmbalagem.MEDIO), 0.001f);
    }

    @Test
    void testCalculaPrecoExpedicaoGrande() {
        float expected = (30.0f * 1.6f * (1 + 0.2f)) * 0.9f;
        assertEquals(expected, t.calculaPrecoExpedicao(Encomenda.TamanhoEmbalagem.GRANDE), 0.001f);
    }
